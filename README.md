...
| [`cafs`](https://github.com/qri-io/qfs/cafs) | [![Go Docs](https://godoc.org/github.com/qri-io/qfs/cafs?status.svg)](https://godoc.org/github.com/qri-io/qfs/cafs) | [![report](https://goreportcard.com/badge/github.com/qri-io/qfs/cafs)](https://goreportcard.com/report/github.com/qri-io/qfs/cafs) | stands for "content addressed file system", this is the seam that communicates with a specific CAFS, current options are IPFS and an in-memory file system |

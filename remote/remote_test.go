...
func TestDatasetPullPushDeleteFeedsPreviewHTTP(t *testing.T) {
	...
	tr.NodeB.Repo.Bus().Subscribe(func(_ context.Context, typ event.Type, _ int64, _ string, _ interface{}) error {
		switch typ {
		...
		"recent": {
			{
				...
				Path:       "/ipfs/QmZfdWYRyH2TZ1ypVdVufhsjLDtow15RMWJqhEdD9rdGeT",

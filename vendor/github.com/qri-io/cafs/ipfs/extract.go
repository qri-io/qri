...
func (te *TarExtractor) Extract(reader io.Reader) error {
...
func (te *TarExtractor) outputPath(tarPath string) string {
...
func (te *TarExtractor) extractDir(h *tar.Header, depth int) error {
...
func (te *TarExtractor) extractSymlink(h *tar.Header) error {
	return os.Symlink(h.Linkname, te.outputPath(h.Name))
}

func (te *TarExtractor) extractFile(h *tar.Header, r *tar.Reader, depth int, rootExists bool, rootIsDir bool) error {
	path := te.outputPath(h.Name)

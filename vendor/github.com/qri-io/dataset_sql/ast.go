...
// References returns a slice of the table names this statement refers to
// This was added by b5.
// TODO - determine weather this can be removed in favour of something else
...
// This was added by b5.
// TODO - determine weather this can be removed in favour of something else
// TODO - write tests to confirm this works, for instance, do we need to
// deduplicate between left & right references? would that be an err?
func (node *Union) References() []string {
	return append(node.Left.References(), node.Right.References()...)
}
...
func (node *Insert) References() []string {
	return []string{node.Table.Name.String()}
}

...
func TestLogbookCommand(t *testing.T) {
	...
	template := `[{"ops":[{"type":"init","model":"user","name":"test_peer_logbook","authorID":"%s","timestamp":"timeStampHere"}],"logs":[{"ops":[{"type":"init","model":"dataset","name":"test_movies","authorID":"%s","timestamp":"timeStampHere"}],"logs":[{"ops":[{"type":"init","model":"branch","name":"main","authorID":"%s","timestamp":"timeStampHere"},{"type":"init","model":"commit","ref":"/ipfs/Qmb6HLvyhZe768NLRjxDUe3zMA75yWiex7Kwq86pipQGBf","timestamp":"timeStampHere","size":224,"note":"created dataset from body_ten.csv"},{"type":"init","model":"commit","ref":"/ipfs/Qme25ndZR9XSd1xmkrEhWvCY2mfnw2w7srrXopiMHY1rrA","prev":"/ipfs/Qmb6HLvyhZe768NLRjxDUe3zMA75yWiex7Kwq86pipQGBf","timestamp":"timeStampHere","size":720,"note":"body changed by 70%%"}]}]}]}]`

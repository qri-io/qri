...
func TestSaveRun(t *testing.T) {
	...
	cases := []struct {
		...
		{"add transform", "me/movies", "testdata/movies/dataset_with_tf.json", "", "", "", false, false, false, "dataset saved: peer/movies@QmZePf5LeXow3RW5U1AgEiNbW46YnRGhZ7HPvm1UmPFPwt/map/QmU2JZo9BJsFKcHmEVyGWVUaopqbYioonGTFg54fToSLMv\nthis dataset has 1 validation errors\n", "", ""},
	}

...
func TestRemoveRun(t *testing.T) {
	...
	cases := []struct {
		...
		{[]string{"me/movies"}, -1, "removed entire dataset 'peer/movies@/mem/QmceRMKDwiNPiKpjWVbX9RQeQZzMW3e5geMiL1aVd4min2'\n", "", ""},
		{[]string{"me/cities", "me/counter"}, -1, "removed entire dataset 'peer/cities@/mem/QmUms8Qzf5FjptS34EP6gt7H1uZBjzXuN1F4KouPx3FscX'\n", "", ""},

...
func TestSaveThenOverrideTransform(t *testing.T) {
	...
	expect := `{"bodyPath":"/ipfs/QmXhsUK6vGZrqarhw9Z8RCXqhmEpvtVByKtaYVarbDZ5zn","commit":{"author":{"id":"QmeL2mdVka1eahKENjehK6tBxkkpk5dNQ1qMcgWi7Hrb4B"},"message":"\t- modified scriptPath\n\t- modified syntax\n\t- ...\n...modified syntaxVersion","path":"/ipfs/QmRhQQECYQJABS4nuyCHJaoQr5PbSecFb8vGvBoB4Myfpr","qri":"cm:0","signature":"","timestamp":"2001-01-01T01:02:01.000000001Z","title":"Transform: 3 changes"},"meta":{"qri":"md:0","title":"example movie data"},"path":"/ipfs/QmaV6De6Lg962EFfiBZUpYTwRqVdphFA8X5qQYaQuf1h34","peername":"me","previousPath":"/ipfs/QmdxjWGrjc9neXqReY6bHMC4eGG5je358PcCWCHNVYbLGU","qri":"ds:0","structure":{"checksum":"QmcXDEGeWdyzfFRYyPsQVab5qszZfKqxTMEoXRDSZMyrhf","depth":2,"errCount":1,"entries":8,"format":"csv","formatConfig":{"headerRow":true,"lazyQuotes":true},"length":224,"qri":"st:0","schema":{"items":{"items":[{"title":"movie_title","type":"string"},{"title":"duration","type":"integer"}],"type":"array"},"type":"array"}},"transform":{"qri":"tf:0","scriptPath":"/ipfs/Qmb69tx5VCL7q7EfkGKpDgESBysmDbohoLvonpbgri48NN","syntax":"starlark","syntaxVersion":"0.9.2"},"viz":{"format":"html","qri":"vz:0","renderedPath":"/ipfs/QmXkN5J5yCAtF8GCxwRXARzAQhj3bPaSv1VHoyCCXzQRzN","scriptPath":"/ipfs/QmVM37PFzBcZn3qqKvyQ9rJ1jC8NkS8kYZNJke1Wje1jor"}}`
	if diff := cmp.Diff(expect, actual); diff != "" {
		t.Errorf("dataset (-want +got):\n%s", diff)
	}
}
...
func TestSaveThenOverrideMetaAndTransformAndViz(t *testing.T) {
	...
	expect := `{"bodyPath":"/ipfs/QmXhsUK6vGZrqarhw9Z8RCXqhmEpvtVByKtaYVarbDZ5zn","commit":{"author":{"id":"QmeL2mdVka1eahKENjehK6tBxkkpk5dNQ1qMcgWi7Hrb4B"},"message":"\t- modified scriptPath\n\t- modified syntax\n\t- ...\n...modified syntaxVersion","path":"/ipfs/QmRhQQECYQJABS4nuyCHJaoQr5PbSecFb8vGvBoB4Myfpr","qri":"cm:0","signature":"","timestamp":"2001-01-01T01:02:01.000000001Z","title":"Transform: 3 changes"},"meta":{"qri":"md:0","title":"different title"},"path":"/ipfs/Qmbkwkj4TFoo7YozXBpKN5g4nevpoHFcxXzBEXJBn4xLLQ","peername":"me","previousPath":"/ipfs/QmdxjWGrjc9neXqReY6bHMC4eGG5je358PcCWCHNVYbLGU","qri":"ds:0","structure":{"checksum":"QmcXDEGeWdyzfFRYyPsQVab5qszZfKqxTMEoXRDSZMyrhf","depth":2,"errCount":1,"entries":8,"format":"csv","formatConfig":{"headerRow":true,"lazyQuotes":true},"length":224,"qri":"st:0","schema":{"items":{"items":[{"title":"movie_title","type":"string"},{"title":"duration","type":"integer"}],"type":"array"},"type":"array"}},"transform":{"qri":"tf:0","scriptPath":"/ipfs/Qmb69tx5VCL7q7EfkGKpDgESBysmDbohoLvonpbgri48NN","syntax":"starlark","syntaxVersion":"0.9.2"},"viz":{"format":"html","qri":"vz:0","renderedPath":"/ipfs/QmVrEH7T7XmdJLym8YL9DjwCALbz264h7GQTrjkSGmbvry","scriptPath":"/ipfs/QmRaVGip3V9fVBJheZN6FbUajD3ZLNjHhXdjrmfg2JPoo5"}}`
	if diff := cmp.Diff(expect, actual); diff != "" {
		t.Errorf("dataset (-want +got):\n%s", diff)
	}
}

...
func TestSaveWithBodyThenAddMetaComponent(t *testing.T) {
	...
	expect := `{"bodyPath":"/ipfs/QmXhsUK6vGZrqarhw9Z8RCXqhmEpvtVByKtaYVarbDZ5zn","commit":{"author":{"id":"QmeL2mdVka1eahKENjehK6tBxkkpk5dNQ1qMcgWi7Hrb4B"},"message":"meta added","path":"/ipfs/QmP6DX3RBb6Nqcmyt5jz3YUhXvJ4931rwG2BPNE1KZibHZ","qri":"cm:0","signature":"","timestamp":"2001-01-01T01:05:01.000000001Z","title":"meta added"},"meta":{"qri":"md:0","title":"different title"},"path":"/ipfs/QmWnDmrQ3XPkEaH2PWbSWi2tKysnfRNC5ygGsFikaD3L4i","peername":"me","previousPath":"/ipfs/QmQ8xUVwptw46kxxNBAw974LZsY58kCWorCbF7Bf2n2D5n","qri":"ds:0","structure":{"checksum":"QmcXDEGeWdyzfFRYyPsQVab5qszZfKqxTMEoXRDSZMyrhf","depth":2,"errCount":1,"entries":8,"format":"csv","formatConfig":{"headerRow":true,"lazyQuotes":true},"length":224,"qri":"st:0","schema":{"items":{"items":[{"title":"movie_title","type":"string"},{"title":"duration","type":"integer"}],"type":"array"},"type":"array"}}}`
	if diff := cmp.Diff(expect, actual); diff != "" {
		t.Errorf("dataset (-want +got):\n%s", diff)
	}
}
...
func TestSaveTransformModifiedButSameBody(t *testing.T) {
	...
	expect := `1   Commit:  /ipfs/Qmei7pHDb8Qi7B2X4U2o6chMn8nweRW3zK1FDmJgPFagGm
...
2   Commit:  /ipfs/QmfWh1FFw7h8xZAcLfp6YYhuYiSQYPtmFP1q1GvqvhfrYU

...
func TestDatasetMethodsDiff(t *testing.T) {
	...
	good := []struct {
		...
		{"two fully qualified references",
			...
			"",
			&DiffStat{Left: 209, Right: 209, LeftWeight: 5017, RightWeight: 5017, Inserts: 0, Updates: 0, Deletes: 0},
			8,
		},
		{"fill left path from history",
			dsRef2.Alias(), dsRef2.Alias(),
			"",
			&DiffStat{Left: 205, Right: 209, LeftWeight: 4920, RightWeight: 5017, Inserts: 19, Updates: 0, Deletes: 13},
			10,
		},

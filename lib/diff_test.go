...
func TestDatasetMethodsDiff(t *testing.T) {
	...
	good := []struct {
		...
		{"two fully qualified references",
			...
			"",
			&DiffStat{Left: 73, Right: 74, LeftWeight: 3226, RightWeight: 3184, Inserts: 11, Updates: 0, Deletes: 11},
			9,
		},
		{"fill left path from history",
			dsRef2.Alias(), dsRef2.Alias(),
			"",
			&DiffStat{Left: 74, Right: 74, LeftWeight: 3234, RightWeight: 3184, Inserts: 11, Updates: 0, Deletes: 12},
			10,
		},
...
func TestDiff(t *testing.T) {
	...
	expect := `{"stat":{"leftNodes":72,"rightNodes":72,"leftWeight":2914,"rightWeight":2954,"inserts":21,"deletes":21},"diff":[["-","bodyPath","/mem/Qmc7AoCfFVW5xe8qhyjNYewSgBHFubp6yLM3mfBzQp7iTr"],["+","bodyPath","/mem/QmYuVj1JvALB9Au5DNcVxGLMcWCDBUfbKCN3QbpvissSC4"],[" ","commit",null,[[" ","author",{"id":"QmZePf5LeXow3RW5U1AgEiNbW46YnRGhZ7HPvm1UmPFPwt"}],["-","message","created dataset from body.csv"],["+","message","created dataset from body_more.csv"],["-","path","/mem/QmNkn95s2VH9HmrHM5KdQqGTHU3FuEuTnnvMeN9abjvCCb"],["+","path","/mem/QmabUumrZhxXRmLrEFFbi5mQthrBFUMcQ2EGbbr5QpLXeT"],[" ","qri","cm:0"],["-","signature",""],["+","signature",""],["-","timestamp","2001-01-01T01:01:01.000000001Z"],["+","timestamp","2001-01-01T01:02:01.000000001Z"],["-","title","created dataset from body.csv"],["+","title","created dataset from body_more.csv"]]],["-","path","/mem/QmcjPHMw4LbodqeLQmMmU8Suk24Ge7Up6NiiMphbSCq1xN"],["+","path","/mem/QmNNVxEWsL9Dba1gSUVb1usycCMmqAMYezMu2hFkXyDCfW"],[" ","qri","ds:0"],[" ","stats",null,[["-","path","/mem/QmdZtz47eYPeB8PonUB2tVMC6Z96C6PUZR8jH2y8JPwPFr"],["+","path","/mem/QmVYaBfgG8HxKJ9Ypi1rLVRQjwYCHP5GErLJCLq8fbx7GM"],[" ","qri","sa:0"],[" ","stats",null,[[" ",0,null,[["-","count",5],["+","count",7],[" ","frequencies",{}],["-","maxLength",8],["+","maxLength",11],[" ","minLength",7],[" ","type","string"]]],[" ",1,null,[["-","count",5],["+","count",7],[" ","histogram",{"bins":null,"frequencies":[]}],["-","max",50000000],["+","max",70000000],["-","mean",59085000],["+","mean",133075000],[" ","min",35000],[" ","type","numeric"]]],[" ",2,null,[["-","count",5],["+","count",7],[" ","histogram",{"bins":null,"frequencies":[]}],[" ","max",65.25],["-","mean",260.2],["+","mean",331.5],["-","min",44.4],["+","min",28.6],[" ","type","numeric"]]],[" ",3,null,[["-","count",5],["+","count",7],["-","falseCount",1],["+","falseCount",2],["-","trueCount",4],["+","trueCount",5],[" ","type","boolean"]]]]]]],[" ","structure",null,[[" ","depth",2],["-","entries",5],["+","entries",7],[" ","format","csv"],[" ","formatConfig",{"headerRow":true,"lazyQuotes":true}],["-","length",155],["+","length",217],[" ","qri","st:0"],[" ","schema",{"items":{"items":[{"title":"city","type":"string"},{"title":"pop","type":"integer"},{"title":"avg_age","type":"number"},{"title":"in_usa","type":"boolean"}],"type":"array"},"type":"array"}]]]]}`
	if diff := cmp.Diff(expect, output); diff != "" {
		t.Errorf("output mismatch (-want +got):\n%s", diff)
	}

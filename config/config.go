...
// TODO: There should be no need for a version of DefaultConfig which *does* generate crypto keys
// and peerID, but right now certain tests depend upon it. In prod, these keys and peerID always
// come from the config generated by the `setup` command. Soon, update all tests to use the
// keyless version, getting keys and peerIDs from config/test/test_peers. Then delete this method
// and rename `DefaultConfigWithoutKeys` to `DefaultConfig`.
